...
const AdminHomePage = () => {
  ...
  //   config.base_url + endpoints.getHCtotalPieData,
  //   {},
  //   [],
  //   true
  // );
  // const totalPieData = totalPieDataLink.data;
  // console.log(`totalPieDataLink: ${totalPieDataLink}`);
  // console.log(`totalPieData: ${totalPieData}`);

  // // 2022 and 2023 has no pending workshops because it should have been resolved

  // const yearPieDataLink = useAxiosGet(
  //   config.base_url + endpoints.getHCyearsPieData,
  //   {},
  //   [],
  //   true
  // );
  // const yearPieData = yearPieDataLink.data;
  // console.log(`yearPieDataLink: ${yearPieDataLink}`);
  // console.log(`yearPieData: ${yearPieData}`);

  // const COLORS = ["#88D66C", "#FF4C4C", "#FFD35A"];

  // const workshopTypesDataLink = useAxiosGet(
  //   config.base_url + endpoints.getHCWorkshopTypesData,
  //   {},
  //   [],
  //   true
  // );
  // const workshopTypesData = workshopTypesDataLink.data;
  // console.log(`workshopTypesDataLink: ${workshopTypesDataLink}`);
  // console.log(`workshopTypesData: ${workshopTypesData}`);

  // const clientTypesDataLink = useAxiosGet(
  //   config.base_url + endpoints.getHCClientTypesData,
  //   {},
  //   [],
  //   true
  // );
  // const clientTypesData = clientTypesDataLink.data;
  // console.log(`clientTypesDataLink: ${clientTypesDataLink}`);
  // console.log(`clientTypesData: ${clientTypesData}`);

  // const workshopTrendDataLink = useAxiosGet(
  //   config.base_url + endpoints.getHCWorkshopTrendData,
  //   {},
  //   [],
  //   true
  // );
  // const workshopTrendData = workshopTrendDataLink.data;
  // console.log(`workshopTrendDataLink: ${workshopTrendDataLink}`);
  // console.log(`workshopTrendData: ${workshopTrendData}`);
  ///////////////////////////////////////////////////////////
  // Functions
  ///////////////////////////////////////////////////////////
