...
describe("Client Home Page Test", () => {
    ...
    it("Testing Populate Button Functionality", () => {
        ...
        cy.get('input[placeholder="Workshop ID"]').should("have.value", "WS01").wait(500);
        cy.get('input[placeholder="Workshop Name"]').should("have.value", "Introduction to Python").wait(2000);
    });

    it('Testing Form Inputs', () => {
        cy.get('form').within(() => {
            cy.get('input[placeholder="Workshop ID"]').type("WS01");
            cy.get('input[placeholder="Workshop Name"]').type("Introduction to Python");
            ...
            cy.get('textarea[placeholder="Your Message"]').type("Looking forward to the workshop!").wait(2000);
        });
    });
    ...
    it("Testing Submit Request Button and Summary Popup", () => {
        ...
        cy.get('.summary-modal', { timeout: 20000 }).should("be.visible").wait(3000);
    ...
    it("Testing Reset Button Functionality", () => {
        ...
        cy.get('textarea[placeholder="Your Message"]').should("have.value", "").wait(2000);
    });
});
